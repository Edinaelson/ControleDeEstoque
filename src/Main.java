...
public class Main {
    public static void main(String[] args) throws Exception{
        ...
        Fisico f1 = new Fisico("Ana Carolina","07403743385",1,1600);
...
//        System.out.println("---------------------------------");
        ...
        Produto prod1 = new Produto("Prego",123,10,30.25);
        ...
        System.out.println("----------------------------------");
        try {
            if(prod1.efetuarCompra(5) == 1){
                c1.cadastrarProdutosComprados(prod1.getNome());
                c1.comprarProduto(5,prod1.getPreco(),prod1);
            }
